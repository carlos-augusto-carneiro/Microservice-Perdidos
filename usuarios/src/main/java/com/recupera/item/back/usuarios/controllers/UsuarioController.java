...
public class UsuarioController {
    ...
    public ResponseEntity<DTOLoginResponse> loginUser(@RequestBody DTOLoginRequest loginDto){
        ...
        usuarioService.publicarLogin(user.getId(), user.getNome(), user.getPerfil().name());
    ...
    @PutMapping("/reenviar-email-confirmacao")
    public ResponseEntity<String> reenviarEmailConfirmacao(@RequestParam String email) {
        try {
